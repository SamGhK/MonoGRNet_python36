...
LABEL_DIR = os.path.join(os.getcwd(), 'outputs/kittiBox/val_out')

# Left RGB images
IMAGE_DIR = os.path.join(os.getcwd(), 'data/KittiBox/training/image_2')

LIDAR_DIR = os.path.join(os.getcwd(), 'data/KittiBox/training/velodyne')
CALIB_DIR = os.path.join(os.getcwd(), 'data/KittiBox/training/calib')
