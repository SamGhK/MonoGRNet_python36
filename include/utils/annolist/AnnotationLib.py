...
import include.utils.annolist.PalLib as PalLib
...
class AnnoRect(object):
        def __init__(self, x1=-1, y1=-1, x2=-1, y2=-1, height=-1, width=-1, length=-1, x=-1, y=-1, z=-1, alpha=-1, calib=None, calib_pinv=None):
